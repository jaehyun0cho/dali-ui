...
/**
 * @brief Verifies the FlexShrink property, which controls how items shrink
 ...
 *
 * Ported from samples/flexlayout/flexlayout-shrink-example.cpp.
 */
class TcFlexLayoutShrink : public ManualTest::TestCase, public ConnectionTracker
{
public:
  Dali::String GetName() const override
  {
    return "FlexLayout: FlexShrink";
  }

  Dali::String GetDescription() const override
  {
    return "Default shrink vs. shrink 0 / 1 / 3 with overflowing flex-basis";
  }
...
REGISTER_MANUAL_TEST(TcFlexLayoutShrink)
