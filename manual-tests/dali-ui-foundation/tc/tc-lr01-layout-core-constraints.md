...
Profile `diagnostic / release`: 61 scenario, 61 action, 226 checks. diagnostics가 필수인 action은 OFF의 capability 실패를 PASS로 처리하지 마십시오.

| Scenario ID | 순서대로 실행할 action ID : required_checks |
|---|---|
| `C01.empty..0` | `run` : 4 |
| `C02.fixed..0.0.000000` | `run` : 6 |
| `C02.fixed..0.1.000000` | `run` : 6 |
| `C02.fixed..0.37.500000` | `run` : 6 |
| `C02.fixed..0.120.000000` | `run` : 6 |
| `C07.clamp..0.39.000000` | `run` : 2 |
| `C07.clamp..0.40.000000` | `run` : 2 |
| `C07.clamp..0.41.000000` | `run` : 2 |
| `C07.clamp..0.99.000000` | `run` : 2 |
| `C07.clamp..0.100.000000` | `run` : 2 |
| `C07.clamp..0.101.000000` | `run` : 2 |
| `C08.equal-bounds..0` | `run` : 4 |
| `C01.empty..1` | `run` : 4 |
| `C02.fixed..1.0.000000` | `run` : 6 |
| `C02.fixed..1.1.000000` | `run` : 6 |
| `C02.fixed..1.37.500000` | `run` : 6 |
| `C02.fixed..1.120.000000` | `run` : 6 |
| `C07.clamp..1.39.000000` | `run` : 2 |
| `C07.clamp..1.40.000000` | `run` : 2 |
| `C07.clamp..1.41.000000` | `run` : 2 |
| `C07.clamp..1.99.000000` | `run` : 2 |
| `C07.clamp..1.100.000000` | `run` : 2 |
| `C07.clamp..1.101.000000` | `run` : 2 |
| `C08.equal-bounds..1` | `run` : 4 |
| `C01.empty..2` | `run` : 4 |
| `C02.fixed..2.0.000000` | `run` : 6 |
| `C02.fixed..2.1.000000` | `run` : 6 |
| `C02.fixed..2.37.500000` | `run` : 6 |
| `C02.fixed..2.120.000000` | `run` : 6 |
| `C07.clamp..2.39.000000` | `run` : 2 |
| `C07.clamp..2.40.000000` | `run` : 2 |
| `C07.clamp..2.41.000000` | `run` : 2 |
| `C07.clamp..2.99.000000` | `run` : 2 |
| `C07.clamp..2.100.000000` | `run` : 2 |
| `C07.clamp..2.101.000000` | `run` : 2 |
| `C08.equal-bounds..2` | `run` : 4 |
| `C01.empty..3` | `run` : 4 |
| `C02.fixed..3.0.000000` | `run` : 6 |
| `C02.fixed..3.1.000000` | `run` : 6 |
| `C02.fixed..3.37.500000` | `run` : 6 |
| `C02.fixed..3.120.000000` | `run` : 6 |
| `C07.clamp..3.39.000000` | `run` : 2 |
| `C07.clamp..3.40.000000` | `run` : 2 |
| `C07.clamp..3.41.000000` | `run` : 2 |
| `C07.clamp..3.99.000000` | `run` : 2 |
| `C07.clamp..3.100.000000` | `run` : 2 |
| `C07.clamp..3.101.000000` | `run` : 2 |
| `C08.equal-bounds..3` | `run` : 4 |
| `C01.empty..4` | `run` : 4 |
| `C02.fixed..4.0.000000` | `run` : 6 |
| `C02.fixed..4.1.000000` | `run` : 6 |
| `C02.fixed..4.37.500000` | `run` : 6 |
| `C02.fixed..4.120.000000` | `run` : 6 |
| `C07.clamp..4.39.000000` | `run` : 2 |
| `C07.clamp..4.40.000000` | `run` : 2 |
| `C07.clamp..4.41.000000` | `run` : 2 |
| `C07.clamp..4.99.000000` | `run` : 2 |
| `C07.clamp..4.100.000000` | `run` : 2 |
| `C07.clamp..4.101.000000` | `run` : 2 |
| `C08.equal-bounds..4` | `run` : 4 |
| `C03.intrinsic` | `run` : 6 |
