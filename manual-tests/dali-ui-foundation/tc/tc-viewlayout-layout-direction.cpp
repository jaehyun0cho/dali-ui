...
/**
 * @brief Verifies LayoutDirection mirroring on a plain View.
 *
 * Same content as ViewLayout: Margin.  A 200x50 translucent-black
 ...
 * the top-left.
 *
 * Ported from samples/viewlayout/view-layout-direction-example.cpp.
 */
class TcViewLayoutLayoutDirection : public ManualTest::TestCase, public ConnectionTracker
{
public:
  Dali::String GetName() const override
  {
    return "ViewLayout: LayoutDirection Toggle";
  }

  Dali::String GetDescription() const override
  {
    return "RTL mirrors direct children of a plain View; the STANDALONE toggle stays put";
  }
...
REGISTER_MANUAL_TEST(TcViewLayoutLayoutDirection)
