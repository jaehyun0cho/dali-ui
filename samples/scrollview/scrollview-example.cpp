...
private:
  ...
  void RefreshFocusPanel()
  {
    ...
    Label::DownCast(mScrollOnFocusChip.GetChildAt(0, ChildScopePolicy::LAYOUT_CHILDREN)).SetText(sv.str().c_str());
    ...
    Label::DownCast(mKeyScrollChip.GetChildAt(0, ChildScopePolicy::LAYOUT_CHILDREN)).SetText(kl.str().c_str());
