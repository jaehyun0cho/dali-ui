Name:       com.samsung.dali.dialog
Summary:    DALi UI Dialog sample
Version:    2.0.0
Release:    1
...
%description
DALi UI Dialog sample application.
...
%define app_root_dir     samples/dialog/
