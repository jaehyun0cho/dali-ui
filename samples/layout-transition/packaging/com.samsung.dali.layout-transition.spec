Name:       com.samsung.dali.layout-transition
Summary:    DALi UI LayoutTransition sample
Version:    2.0.0
Release:    1
...
%description
DALi UI LayoutTransition sample application.
...
%define app_root_dir     samples/layout-transition/
