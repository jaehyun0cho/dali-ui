...
public:
  ...
  bool OnToggleClicked(View, InputEvent)
  {
...
private:
  void CreateToggleButton(Window window, View root)
  {
    ...
    mToggleButton.ConnectClickedSignal(this, &AbsoluteLayoutWrapContentPositionProportionalLabelController::OnToggleClicked);
