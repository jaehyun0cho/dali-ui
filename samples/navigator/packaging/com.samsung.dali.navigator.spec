Name:       com.samsung.dali.navigator
Summary:    DALi UI Navigator sample
Version:    2.0.0
Release:    1
...
%description
DALi UI Navigator sample application.
...
%define app_root_dir     samples/navigator/
